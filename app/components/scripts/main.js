export default class MobileMegaMenu {
	constructor(element) {
		this._name = 'MobileMegaMenu';
		this.defaultOptions = {
...
// (function(){
// 	/**
// 	 * Add window.$ to attach
// 	 * plugin to external webpack jQuery
// 	 */
// 	window.$.fn.extend({
...
// 				/* Variables */
// 				let animationSpeed 	= 250, // Change SCSS to match this speed
...
// 				let $menuRoot 		= $(this), // Root of Mobile Mega Menu
...
// 				/* Variables */
// 				let $toggleMenu 	= $('a.' + settings.menuToggle), // DOM Search for Menu Toggle
...
// 					let widgets = $menuRoot.find('.widget-region').detach();
